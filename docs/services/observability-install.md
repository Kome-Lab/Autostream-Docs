...
| service token | Observability が Control Panel へ登録する |
...
SERVICE_PUBLIC_URL=https://<OBSERVABILITY_HOST>
...
2. Observability を起動します。
3. Service Health で online を確認します。
4. Monitoring Dashboard を開きます。
5. Notification Channels で通知先を作ります。
6. Test Channel を実行します。
7. Incidents と Diagnostics を確認します。
