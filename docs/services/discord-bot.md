...
| Discord Settings | Bot token、Bot service ID、reconnect、audio forward |
...
8. [Discord Settings](/control-panel/discord-youtube) に Bot token と Bot service ID を登録します。
...
- chat overlay を使う場合は、Bot に text channel の閲覧権限と Message Content Intent があるか確認します。
