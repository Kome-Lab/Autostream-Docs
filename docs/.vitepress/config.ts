export default {
  ...
  themeConfig: {
    ...
    sidebar: [
      { text: 'まず読む', items: [ { text: 'AutoStreamとは', link: '/overview/what-is-autostream' }, { text: '最初のインストール', link: '/runbooks/first-install' }, { text: 'Dockerで動かす', link: '/deployment/docker' }, { text: '設定項目', link: '/configuration/environment-variables' }, { text: '最初の配信を始める', link: '/runbooks/start-first-stream' } ] },
      { text: '日常の使い方', items: [ { text: '配信を開始・停止する', link: '/operations/start-stop-stream' }, { text: '録画と保存', link: '/operations/archive-flow' }, { text: '状態を確認する', link: '/operations/monitoring' }, { text: 'バックアップと復元', link: '/operations/backup-restore' } ] },
