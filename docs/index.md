...
4. [Linuxホストで直接動かす](/deployment/host)
5. [設定項目](/configuration/environment-variables)
6. [初回管理者を作る](/runbooks/create-first-admin)
7. [最初の配信を始める](/runbooks/start-first-stream)
8. [困ったとき](/troubleshooting/)
