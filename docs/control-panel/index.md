...
| 順番 | 画面 | ここでやること |
| --- | --- | --- |
| 1 | Node登録 | 各サービス用 Node を作り、`config.yml` を取得する |
...
| Node登録 | サービス用 `config.yml`、Configure Token、Node Runtime Token を作成する | [Node Agent登録](/control-panel/node-agent-registration) |
