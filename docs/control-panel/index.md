...
| 4 | Discord Settings | Discord Bot token と Bot service ID を登録する |
...
| Discord Settings | Discord Bot token、Bot service ID、音声転送、再接続を登録する | [DiscordとYouTube](/control-panel/discord-youtube) |
...
| Account | ログイン中ユーザーのメール、password、MFA、Passkey、OAuth連携を管理する | [ユーザーとセキュリティ](/control-panel/users-roles-security) |
